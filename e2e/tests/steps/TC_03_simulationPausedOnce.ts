...
Given('User logged in to Audirie platform', async function () {
...
When('User launches Aged Care simulation from dashboard', async function () {
...
Then('User respond to Avatar', async function () {
...
Then('User pause simulation', async function () {

   await getPage().locator('//a[text()="Pause"]').click();
   await getPage().locator('//button[text()="Confirm"]').click();
   await getPage().waitForTimeout(10000);

});

Then('Dashboard should state simulation is paused', async function () {

   await getPage().locator('//button[text()="Back to Dashboard"]').click();
