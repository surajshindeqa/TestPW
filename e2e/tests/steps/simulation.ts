...
// async function simulateAudioInput(filePath: string) {
//    // Create a PulseAudio client instance
//    const client = new PulseAudio('unix:/run/pulse/native');
...
//        const playbackStream = await client.createPlaybackStream({
//            stream: 'Simulated Audio Stream',
//            device: 'null-sink', // Use null-sink or specify your virtual sink name
//            format: 'S16LE', // Sample format (16-bit signed little-endian)
//            rate: 44100, // Sample rate
//            channels: 2, // Stereo
//            latency: 250000 // Latency in microseconds (optional)
//        });

//        console.log('Playback stream created. Playing audio...');

//        // Read the audio file and pipe it to the playback stream
//        const audioStream = fs.createReadStream(filePath);
       
//        audioStream.on('data', (chunk) => {
//            playbackStream.write(chunk); // Write chunks of audio data to the stream
//        });

//        audioStream.on('end', () => {
//            console.log('Finished playing audio.');
//            playbackStream.end(); // End the playback stream when done
//            client.disconnect(); // Disconnect from PulseAudio server
//        });

//        playbackStream.on('error', (error: any) => {
